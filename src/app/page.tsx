  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col overflow-x-hidden">
      ...
      <section className="relative">
        ...
        />
        {/* Dark mode atmosphere — keep surfaces dark so light text stays readable */}
        <div
          className="pointer-events-none absolute inset-0 -z-10 hidden dark:block"
          aria-hidden
          style={{
            backgroundImage: `
              radial-gradient(ellipse 90% 55% at 75% 0%, rgba(13,148,136,0.28), transparent 55%),
              radial-gradient(ellipse 45% 40% at 5% 85%, rgba(251,191,36,0.1), transparent 45%),
              linear-gradient(180deg, hsl(222 28% 9%) 0%, hsl(var(--background)) 55%, hsl(222 24% 8%) 100%)
            `,
          }}
        />
        <div
          className="pointer-events-none absolute inset-0 -z-10 opacity-[0.35] dark:opacity-[0.18]"
          aria-hidden
          style={{
            backgroundImage:
